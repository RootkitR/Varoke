...
public class Preferences {
	...
	public Preferences setNavigatorX(int x){
		NavigatorX = x; 
		return this;
	}
	
	public Preferences setNavigatorY(int y){ 
		NavigatorY = y; 
		return this;
	}
	
	public Preferences setNavigatorHeight(int height){ 
		NavigatorHeight = height; 
		return this;
	}
	
	public Preferences setNavigatorWidth(int width){ 
