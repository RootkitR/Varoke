...
public class Item {
	...
	public int getFlatId(){return this.FlatId;}
	public int getInteractionsModes(){ return this.InteractionModeCount;}
	public int getEffect(){ return this.EffectId;}
	public int getSpriteId(){ return Sprite;}
	...
	public List<Integer> getVendingIds(){return this.VendingIds;}
	public List<Double> getStackHeight(){return this.StackHeight;}
	public Double getDefaultStackHeight(){return this.StackHeight.get(0);}
	public boolean canStack(){return this.CanStack;}
	public boolean allowRecycle(){return this.AllowRecycle;}
	public boolean allowTrade(){return this.AllowTrade;}
	public boolean allowMarketplaceSell(){return this.AllowMarketplaceSell;}
	public boolean allowGift(){return this.AllowGift;}
	public boolean allowInventoryStack(){return this.AllowInventoryStack;}
	public boolean isSubscriber(){return this.Subscriber;}
